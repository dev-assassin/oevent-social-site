                    ...
                    <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-sm-12 medium-font" >
                                ...
                                <a (click)="follow()" *ngIf="!following" target="blank" class="pull-left" style="margin-left: 10px;">                           <span aria-hidden="true" class="fa fa-plus-square-o"></span>
                                    Follow
                                </a>
