...
export class FollowingComponent implements OnInit{
    ...
    constructor(private auth: AuthService, private appService: AppService, private router: Router, private route: ActivatedRoute, private followingService: FollowingService) {
