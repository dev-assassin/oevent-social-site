    ...
    template: `
        ...
        <div class="row padding-vertical"> 
            <div class="col-sm-5"> 
                ...
                <input type="radio" value="public" [(ngModel)]="visibility" name="visibility" (click)="saveVisibility()">  Public &nbsp; &nbsp; &nbsp; 
            ...
            <div class="col-sm-7"> 
                ...
                <input type="checkbox" [(ngModel)]="showRemainingTickets" (click)="saveTickets()">  Show Remaining Tickets &nbsp; &nbsp; &nbsp; 
